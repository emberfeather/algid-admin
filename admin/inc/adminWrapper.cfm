<cfsilent>
	<cftimer label="Wrapper - Startup" type="debug">
	...
	<cftimer label="Wrapper - Process" type="debug">
	...
	<cftimer label="Wrapper - Content" type="debug">
		<!--- TODO Add in caching --->
...
<cftimer label="Wrapper - Template" type="debug">
